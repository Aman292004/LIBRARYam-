...
const News = () => {
  ...
  return (
    <div className="py-16">
      <h2 className="text-3xl font-semibold mb-6 md:ml-0 ml-2">News</h2>
      ...
      >
        {news.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-12 md:ml-0 ml-2">
              {/* Content */}
              <div className="py-4">
                <Link to="/">
              ...
              <div className="flex-shrink-0 md:ml-0 ml-2">
